...
export function CreateProjectModal({ isOpen, onClose, onCreate }) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="创建新小说项目">
            ...
            {coverColors.map((c) => (
              <button
                ...
                className={`w-8 h-8 rounded-full transition-all duration-200 ${
                  coverColor === c.value ? 'ring-2 ring-offset-2 ring-[var(--primary)] ring-offset-[var(--surface)] scale-110' : 'hover:scale-105'
                }`}
      ...
      <div className="flex gap-2 pt-5 border-t border-[var(--border)] mt-5">
